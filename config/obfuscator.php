...
return [
    ...
    */
    ...
    |
    | Note: vendor/ and node_modules/ are excluded by default as they should
    | be installed in production via composer install and npm install.
    |
    */
    'production_bundle' => [
        ...
        'exclude_dirs' => [
            ...
            'vendor',            // Install via: composer install --no-dev
            'tests',
            'storage/logs',
        ...
        'exclude_files' => [
            '.env',              // Environment-specific, create in production
            '.env.example',
            '.env.testing',
            '.env.backup',
            '.env.local',
            ...
            'package.json',
            'package-lock.json',
            'composer.lock',     // Will be generated by composer install
            'yarn.lock',
            'pnpm-lock.yaml',
        ...
        'always_include' => [
            ...
            'package.json',     // Required for: npm install --production
            'public/index.php',
            'server.php',
        ],
    ],
